...
data:
    ...
    message5 db  10,13,"Devs:", 10, 13, 10, 13, 10, 13, "Felipe Ferreira da Silva Santos-ffss",10, 13, 10, 13, "Guilherme Montenegro de Albuquerque-gma4",10, 13, "Victor Mendonca Aguiar-vma3", 10, 13, 10, 13, "Vitor Manoel de Melo Silva-vmms", 10, 13, 10, 13, 10, 13,10, 13, "We hope you enjoyed playing PONG SOCCER", 10, 13, 10, 13, 10, 13, 10, 13, 10, 13, 10, 13, 10, 13, "Press SPACE to return to menu", 0
    message2 db  10,13,"This is one of the hardest pong games inworld history!!!", 10, 13, 10, 13, 10, 13,"Try to survive the longest!!!", 10, 13, 10, 13, 10, 13, 10, 13, "How to play:", 10, 13, 10, 13, 10, 13, "    W -> up", 10, 13, 10, 13, "    S -> down", 10, 13, 10, 13, 10, 13, 10, 13, 10, 13, "Press SPACE to return to menu",0
